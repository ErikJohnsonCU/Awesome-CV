...
%---------------------------------------------------------
  \cventry
    ...
    {Capstone Engineering Project - First-In Risk Evaluation (F.I.R.E.) System} % Project title
...
%---------------------------------------------------------
  \cventry
    {Carleton University} % Organization
    {Freescale Cup 2014 (now NXP Cup)} % Project title
    {Ottawa, Ontario, Canada} % Location
    {Oct. 2013 - April 2014} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
